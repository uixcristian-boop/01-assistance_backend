...
// Filtro de autenticacion HTTP para interceptar y validar tokens JWT
@Component
...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(
        ...
        if (jwt != null && tokenProviderPort.validateToken(jwt)) {
            String email = tokenProviderPort.extractEmail(jwt);
